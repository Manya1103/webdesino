    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-cream via-white to-cream relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 relative z-10">
          <Link 
            href="/case-studies" 
            className="inline-flex items-center text-teal hover:text-orange transition-all duration-300 font-medium animate-fade-in"
          >
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-teal mb-6 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              {caseStudy.title}
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <Calendar className="w-12 h-12 text-orange mb-4" />
              <p className="text-sm text-gray-600 mb-2 font-medium">Timeline</p>
              <p className="text-3xl font-bold gradient-text-orange">{caseStudy.heroMetrics.timeline}</p>
            </div>
            <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.7s' }}>
              <Rocket className="w-12 h-12 text-teal mb-4" />
              <p className="text-sm text-gray-600 mb-2 font-medium">Channels</p>
              <p className="text-3xl font-bold gradient-text-teal">{caseStudy.heroMetrics.channels || 'Multi-Channel'}</p>
            </div>
          </div>
        </section>

        {/* Challenges Section */}
        <section className="py-16 lg:py-24 bg-gradient-to-br from-orange/5 via-white to-cream relative overflow-hidden">
          <div className="absolute top-10 right-10 w-72 h-72 bg-orange/10 rounded-full blur-3xl animate-float" />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex items-center mb-8 animate-fade-in">
              <AlertTriangle className="w-10 h-10 text-orange mr-4" />
              <h2 className="text-3xl md:text-5xl font-bold text-teal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {caseStudy.challenges.painPoints.map((point, index) => (
                <div key={index} className="glass-strong rounded-2xl p-8 border-l-4 border-orange hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: `${0.2 + index * 0.1}s` }}>
        ...
        <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
          <div className="absolute bottom-10 left-10 w-72 h-72 bg-teal/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }} />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex items-center mb-12 animate-fade-in">
              <CheckCircle2 className="w-10 h-10 text-teal mr-4" />
              <h2 className="text-3xl md:text-5xl font-bold text-teal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {caseStudy.solutions.pillars.map((pillar, index) => (
                <div key={index} className="glass rounded-3xl p-8 hover-lift transition-all duration-300 animate-scale-in group" style={{ animationDelay: `${0.1 + index * 0.1}s` }}>
                  <div className="w-12 h-12 bg-gradient-orange rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <CheckCircle2 className="text-white" size={24} />
                  </div>
                  <h3 className="text-2xl font-bold text-teal mb-4 group-hover:text-orange transition-colors">{pillar.name}</h3>
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-br from-cream via-white to-cream relative overflow-hidden">
          <div className="absolute top-20 right-20 w-64 h-64 bg-teal/5 rounded-full blur-3xl animate-float" />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex items-center mb-12 animate-fade-in">
              <Users className="w-10 h-10 text-teal mr-4" />
              <h2 className="text-3xl md:text-5xl font-bold text-teal">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                <h3 className="text-2xl font-bold text-teal mb-6">Timeline & Process</h3>
              ...
              <div className="space-y-6">
                <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.15s' }}>
                  <h3 className="text-2xl font-bold text-teal mb-6">Tools & Technology</h3>
                  <div className="flex flex-wrap gap-3">
                    {caseStudy.implementation.tools.map((tool, index) => (
                      <span key={index} className="glass px-4 py-2 rounded-full text-sm font-semibold text-teal hover:bg-teal hover:text-white transition-all duration-300 hover-lift">
                        {tool}
                      </span>
                    ))}
                  </div>
                ...
                <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                  <h3 className="text-2xl font-bold text-teal mb-6">Team Composition</h3>
                  <div className="flex flex-wrap gap-3">
                    {caseStudy.implementation.team.map((member, index) => (
                      <span key={index} className="glass px-4 py-2 rounded-full text-sm font-semibold text-orange hover:bg-orange hover:text-white transition-all duration-300 hover-lift">
                        {member}
                      </span>
                    ))}
                  </div>
        ...
        <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-teal/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
          </div>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex items-center mb-12 animate-fade-in">
              <Award className="w-10 h-10 text-orange mr-4" />
              <h2 className="text-3xl md:text-5xl font-bold text-teal">
                Results That Speak
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="glass-strong rounded-3xl p-8 border-4 border-orange hover-lift transition-all duration-300 animate-scale-in" style={{ animationDelay: '0.2s' }}>
                <h3 className="text-3xl font-bold gradient-text mb-6">After</h3>
                <div className="space-y-4">
                  <p className="text-gray-700 text-lg"><span className="font-bold">Revenue:</span> <span className="gradient-text-orange font-bold">{caseStudy.results.after.revenue}</span></p>
                  {caseStudy.results.after.traffic && (
                    <p className="text-gray-700 text-lg"><span className="font-bold">Traffic:</span> <span className="gradient-text-teal font-bold">{caseStudy.results.after.traffic}</span></p>
                  )}
                  <p className="text-gray-700 text-lg"><span className="font-bold">Visibility:</span> <span className="gradient-text-orange font-bold">{caseStudy.results.after.visibility}</span></p>
                </div>
              </div>
            </div>

            <div className="glass-strong rounded-3xl p-8 lg:p-12 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <h3 className="text-3xl font-bold text-teal mb-8">Key Highlights</h3>
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-br from-cream via-white to-cream">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-teal to-teal/90 rounded-3xl p-12 lg:p-16 shadow-2xl text-white relative overflow-hidden hover-lift transition-all duration-300 animate-scale-in">
              ...
              <div className="relative z-10">
                ...
                <div className="border-t border-white/20 pt-6">
                  ...
                  <p className="text-orange font-semibold">{caseStudy.testimonial.position}, {caseStudy.testimonial.company}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-5xl font-bold text-teal mb-12 animate-fade-in">Key Learnings</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {caseStudy.keyLearnings.map((learning, index) => (
                <div key={index} className="glass-strong rounded-2xl p-8 border-l-4 border-teal hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-br from-cream via-white to-cream">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-5xl font-bold text-teal mb-12 text-center animate-fade-in">
            ...
            <div className="space-y-6">
              {caseStudy.faqs.map((faq, index) => (
                <div key={index} className="glass-strong rounded-2xl p-8 hover-lift transition-all duration-300 animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                  <h3 className="text-xl font-bold text-teal mb-4">{faq.question}</h3>
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-teal mb-12 text-center animate-fade-in">Related Services</h2>
            <div className="flex flex-wrap gap-4 justify-center">
              {caseStudy.relatedServices.map((service, index) => (
                <Link 
                  key={index}
                  href={service.url}
                  className="glass-strong px-6 py-3 rounded-full font-semibold text-teal hover:bg-orange hover:text-white transition-all duration-300 hover-lift animate-fade-in"
